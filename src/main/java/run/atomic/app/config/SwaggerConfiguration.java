...
public class SwaggerConfiguration {
    ...
    public Docket haloDefaultApi() {
        ...
        return buildApiDocket("run.atomic.app.content.api",
                "run.atomic.app.controller.content.api",
                "/api/content/**")
    ...
    public Docket haloAdminApi() {
        ...
        return buildApiDocket("run.atomic.app.admin",
                "run.atomic.app.controller.admin",
                "/api/admin/**")
