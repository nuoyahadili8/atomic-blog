...
import run.atomic.app.core.PageJacksonSerializer;
import run.atomic.app.factory.StringToEnumConverterFactory;
import run.atomic.app.model.support.HaloConst;
import run.atomic.app.security.resolver.AuthenticationArgumentResolver;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "run.atomic.app.controller")
...
public class WebMvcAutoConfiguration implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/admin/**")
                .addResourceLocations(workDir + HaloConst.HALO_ADMIN_RELATIVE_PATH)
                .addResourceLocations("classpath:/admin/");
