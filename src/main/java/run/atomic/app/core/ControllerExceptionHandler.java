...
import run.atomic.app.exception.HaloException;
import run.atomic.app.model.support.BaseResponse;
import run.atomic.app.utils.ExceptionUtils;
 ...
 * @author johnniang
 */
@RestControllerAdvice({"run.atomic.app.controller.admin.api", "run.atomic.app.controller.content.api"})
@Slf4j
