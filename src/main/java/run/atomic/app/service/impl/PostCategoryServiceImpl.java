...
import run.atomic.app.model.dto.CategoryWithPostCountDTO;
import run.atomic.app.model.entity.Category;
import run.atomic.app.model.entity.Post;
import run.atomic.app.model.entity.PostCategory;
import run.atomic.app.model.enums.PostStatus;
import run.atomic.app.model.projection.CategoryPostCountProjection;
...
import run.atomic.app.repository.CategoryRepository;
import run.atomic.app.repository.PostCategoryRepository;
